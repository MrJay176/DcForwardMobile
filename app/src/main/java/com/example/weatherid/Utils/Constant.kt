...
object Constant {
    ...
    var APP_ID = "507f1e95b9effea0aab34e7c71cf8b68"
    fun returnListOfStates(): List<String> {
        val usStates: MutableList<String> = ArrayList()
        ...
        usStates.add("Hawaii")
        usStates.add("Idaho")
        usStates.add("Illinois")
        usStates.add("Indiana")
        usStates.add("Iowa")
        usStates.add("Kansas")
